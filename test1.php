...
if(
	preg_amatch("/(?=.*(ふらっか〜ず|ふらっかーず|フラッカーズ)[\s]?ココッティ[\s]?アシスト)(?=.*2021)/ius","丸石サイクル 電動自転車 子供乗せ 2021 ふらっかーずココッティアシスト マルイシ maruishi 20インチ 10.4Ah 3段変速 オートライト  ASFRR203Y",$match)	){
	print "true!";
}
print_r($match[0]);
print_r($match);
